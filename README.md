# SE4HPCproject
The objective of this project is to apply in practice what we have learnt during the second
part of the course "Software Engineering for HPC" about automating testing and building processes, containerization and usage of HPC clusters through SLURM.

## Part 1 - testing
The goal is to test a specific buggy implementation of the matrix multiplication software. The 
objectives are:
